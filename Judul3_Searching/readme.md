...
[MASUKKAN SCREENSHOT SAAT MENGINPUTKAN DATA DI MENU 1]

Menu 2 (Sequential Search)
Pilih menu: 2
Cari kode (Sequential): 301
Sukses! Kode 301 ditemukan pada indeks ke-2.

[MASUKKAN SCREENSHOT SAAT MENCARI DATA MENGGUNAKAN MENU 2]

Menu 3 (Binary Search)
Pilih menu: 3
Data diurutkan terlebih dahulu: [102, 204, 301, 405, 509]
Cari kode (Binary): 509
Sukses! Kode 509 ditemukan pada indeks ke-4.

[MASUKKAN SCREENSHOT SAAT MENCARI DATA MENGGUNAKAN MENU 3, TERLIHAT DATA DIURUTKAN DULU]
